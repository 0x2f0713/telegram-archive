...
from app.database.models import OperationJob, OperationLog, utc_now
from app.database.session import Database

ACTIVE_OPERATION_STATUSES = frozenset({"queued", "running", "stopping"})
TERMINAL_OPERATION_STATUSES = frozenset({"completed", "failed", "cancelled", "interrupted"})
